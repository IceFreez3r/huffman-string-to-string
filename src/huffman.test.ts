...
describe("HuffmanEncoding", () => {
    it("counts frequencies", () => {
        const frequencies = HuffmanEncoding.getFrequencies("abracadabra");
    ...
    it("builds a tree from frequencies", () => {
        ...
        const tree = HuffmanEncoding.treeFromFrequencies(frequencies);
    ...
    it("builds codes from tree", () => {
        ...
        const codes = HuffmanEncoding.codesFromTree(tree);
        ...
        const codes2 = HuffmanEncoding.codesFromTree(tree2);
    ...
    it("encodes a string", () => {
        ...
        const { compressed, skipLast } = HuffmanEncoding.encodeString(text, codes);
    ...
    it("decodes a string", () => {
        ...
        const skipLast = 8;
        const text = HuffmanEncoding.decodeString(compressed, HuffmanEncoding.treeFromCodes(codes), skipLast);
